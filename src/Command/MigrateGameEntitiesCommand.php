...
class MigrateGameEntitiesCommand extends Command
{
    ...
    private function seedConsoles(SymfonyStyle $io): void
    {
        ...
        $consoles = [
            ...
            ['PS3',      'PlayStation 3',      'fab fa-playstation', '#003791', 3,  9],
            ['PS2',      'PlayStation 2',      'fab fa-playstation', '#003791', 4,  8],
            ...
            ['XOne',     'Xbox One',           'fab fa-xbox',        '#107C10', 11, 49],
            ['X360',     'Xbox 360',           'fab fa-xbox',        '#107C10', 12, 12],
            ['Xbox',     'Xbox',               'fab fa-xbox',        '#107C10', 13, 11],
            ...
            ['3DS',      'Nintendo 3DS',       'fas fa-gamepad',     '#E60012', 25, 37],
